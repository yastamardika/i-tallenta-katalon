...
WebUI.callTestCase(findTestCase('Open Url and Maximize'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Home Page_i-tallenta/a_Jelajah'))

WebUI.click(findTestObject('Object Repository/Order Sanggar Page/img_Bantul_card-img'))
